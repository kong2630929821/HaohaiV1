<template>
  <section class="home-container">
    <main class="home-main main-container">
      <!-- 头块 -->
      <section class="head gradient">
        <section class="fill-canvas-top"></section>
        <canvas id="cas" width="500" height="500" class=" canvas"></canvas>
        <section style="display:flex;justify-content:center;position:relative;z-index:5;height:100%">
          <section class="head-main">
            <h3>
              <imgs src="logo_2.png" style="height:25vh;"></imgs>
            </h3>
            <h1 style="font-size:4.5vh">区块链让世界更公平</h1>
          </section>
          <section class="top-card-outter">
            <section class="top-card-container container layout x-between">
              ...
              <section class="top-card top-card-padding">
                ...
                <section class="top-card-top">
                  <h1 class="top-card-h1">竞争性权益证明</h1>
                </section>
...
<style scoped>
  ...
  .fill-canvas-top {
    ...
    width:100%;
    z-index:10;
    background-image: linear-gradient(-90deg, #004a9c 0%, #012650 100%);
  }
